...
public abstract class Person {
	...
	public void setEmail(String email) throws NotValidEmailException {
		...
		if (!localPart.equals("") && email.contains("@")
				&& (domainPart.contains(".com") || domainPart.contains(".bg"))) {
			this.email = email;
		} else {
	...
	public void setPhoneNum(String phoneNum) throws InvalidParameterException {
		if(phoneNum != null && phoneNum.length() == PHONE_NUM_LENGTH){
			if(phoneNum.equals("^[a-zA-Z]")){
